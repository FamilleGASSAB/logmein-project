...
def test_add_log(client):
    ...
    response = client.post(
        "/logs", data=json.dumps(test_log), content_type="application/json"
    )
...
def test_get_stats(client):
    ...
    for log in test_logs:
        client.post("/logs", data=json.dumps(log), content_type="application/json")
...
def test_invalid_log_data(client):
    ...
    invalid_log = {"invalid_field": "test"}

    response = client.post(
        "/logs", data=json.dumps(invalid_log), content_type="application/json"
    )
